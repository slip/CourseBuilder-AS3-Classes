...
package com.davita.quiz
{
	...
	public class QuizItem_MC extends MovieClip {
		...
		public function addAnswer(answer:String, isCorrectAnswer:Boolean = false):void 
		{
			...
			TweenLite.to(this["check"+_numOfAnswers], 1, {alpha:1});
			TweenLite.to(this["answerMark"+_numOfAnswers], 1, {alpha:1});
			TweenLite.to(this["answerText"+_numOfAnswers], 1, {alpha:1});
		...
		private function hideAllAnswers():void 
		{
			for ( var i:int = 0; i < 5; i++ ) {
				this["check"+i].alpha = 0;
				this["answerMark"+i].alpha = 0;
				this["answerText"+i].alpha = 0;
			}
		}
