package com.davita.special
{
	...
	public class NationwideLoop extends MovieClip
	{
		var sndChannel:SoundChannel = new SoundChannel();
		
		public function NationwideLoop()
		{
			super();
		}
		...
		public function flyinInOut(mcIn:MovieClip, mcOut:MovieClip,delayTime5):void
		{
			stop();
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.to(mcOut, 1, {x:1024, alpha:0,ease:Expo.easeInOut, blurFilter:{blurX:10, blurY:0}}));
			timeline.append(TweenLite.from(mcIn, 1, {x:-1024, alpha:100,ease:Expo.easeInOut, blurFilter:{blurX:10, blurY:0}}));
			timeline.append(TweenLite.delayedCall(delayTime5, play));
		}
		...
		public function scaleFromPosition(mc:MovieClip, xPos, yPos, scale, delayTime13):void
		{
			stop();
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.from(mc, 1, {x:xPos, y:yPos, alpha:1, scaleX:scale, scaleY:scale, ease:Expo.easeInOut}));
			timeline.append(TweenLite.to(mc, .25, {delay:delayTime13}));
		}
		public function scaleFromPositionStop(mc:MovieClip, xPos, yPos, scale, delayTime13):void
		{
			stop();
