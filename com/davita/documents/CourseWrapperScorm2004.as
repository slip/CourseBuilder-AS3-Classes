...
package com.davita.documents
{
	 ...
	 * 	@version 1.0
	 */
	public class CourseWrapperScorm2004 extends MovieClip
	{
		/* ============= */
		/* = Variables = */
		/* ============= */
		...
		private static var _bookmarkedPage:int;
		 ...
		 *	@constructor
		 */
		public function CourseWrapperScorm2004()
		{	
		...
		{	
			...
			if(success){
				...
				if(course.lesson_status == "passed" || course.lesson_status == "completed"){
					...
					course.course_location = scorm.get("cmi.location");
					console("scorm.get('cmi.location'): " +course.course_location);
		...
		private function xmlLoaded(event:Event):void
		{
			...
			_bookmarkedPage = getBookmarkedPage();
		...
		{			
			...
			scorm.set("cmi.location", currentPage.toString());
		...
		{ 
			return parseInt(scorm.get("cmi.location"));
		}
		...
		{
			trace("CourseWrapperScorm2004::LMSSetComplete()");
			if(success)
			{
