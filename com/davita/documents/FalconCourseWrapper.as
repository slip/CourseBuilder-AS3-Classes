...
package com.davita.documents
{
   ...
   *	@since  13.11.2007
   */
  public class FalconCourseWrapper extends MovieClip
  {
    /* ============= */
    /* = Variables = */
    /* ============= */
...
lesson_status: "",
     ...
     *	@constructor
     */
    public function FalconCourseWrapper()
    {	
    ...
    private function drawBackground():void
    {
      ...
      _background.graphics.drawRect(0,0,1000,700);
      addChildAt(_background, 0);
    }

    private function loadFirstOrBookmarkedPage():void
    {
      ...
      trace("loading up in this bitch");
    }
    ...
    {
      unloadAndDestroy();
      queue = new SWFLoader(xmlPages[page].@source, {name:'myLoader',container:this, y:65, estimatedBytes:460800,onProgress:progressHandler, onComplete:completeHandler, onError:errorHandler});
      setCurrentPage(page);
      queue.load(true);
