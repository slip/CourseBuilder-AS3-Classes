...
package com.davita.documents
{
	 ...
	 * 	@version 1.0
	 */
	public class CourseWrapperScorm12 extends MovieClip
	{
		/* ============= */
		/* = Variables = */
		/* ============= */
		 ...
		 *	@constructor
		 */
		public function CourseWrapperScorm12()
		{
		...
		{
			trace("CourseWrapperScorm12::console(): " + msg);
		}
    ...
    public function unloadAndDestroy():void
    {
      ...
      queue = null;
		...
		{
			scorm.set("cmi.core.lesson_location", pageNumber.toString());
		}
