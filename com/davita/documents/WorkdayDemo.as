package com.davita.documents
{
	...
	public class WorkdayDemo extends MovieClip
	{

		public function WorkdayDemo()
		{
			super();
		}
		...
		public function screenIconFadeIn(movieClip:MovieClip):void
		{
			...
			timeline.append(TweenLite.from(movieClip, .5, {alpha:0,x:500,y:150, scaleX:.8, scaleY:.8, delay:.5}));
			timeline.append(TweenLite.to(movieClip, .5, {x:finalX, y:finalY, scaleX:1, scaleY:1, delay:.5}));
		}
		public function featureIconFadeIn(movieClip:MovieClip):void
		{
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			...
			timeline.append(TweenLite.from(movieClip, .5, {alpha:0,x:500,y:450, scaleX:.8, scaleY:.8, delay:.5}));
			timeline.append(TweenLite.to(movieClip, .5, {x:finalX, y:finalY, scaleX:1, scaleY:1, delay:.5}));
		}
		...
		{
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.to(movieClip, .5, {alpha:0,x:500,y:150, scaleX:.5, scaleY:.5, delay:.2, blurFilter:{blurX:5, blurY:5}}));
		}

		public function screenBounceIn(mc:MovieClip):void
		{
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.from(mc, 1.5, {y:-334, ease:Elastic.easeOut, blurFilter:{blurX:5, blurY:5}}));
		}
		...
		public function radiobutton(xPos:int, yPos:int, num:uint):void
		{
			var radiobutton:MovieClip = new RadioButton();
			radiobutton.x = xPos;
			radiobutton.y = yPos;
			radiobutton.name = "radiobutton" + num;
		...
		{
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.from(mc, 1.5, {x:-427, alpha:0,ease:Elastic.easeOut, blurFilter:{blurX:5, blurY:5}}));
		}
		...
		public function mainImageFadeIn(mc:MovieClip):void
		{
			...
			timeline.append(TweenLite.to(mc, .5, {alpha:.5}));
			timeline.append(TweenLite.to(mc, .25, {alpha:1}));
		}

		public function mainImageFadeOut(mc:MovieClip):void
		{
			mc.alpha = 1;
			var timeline:TimelineLite = new TimelineLite({onComplete:play});
			timeline.append(TweenLite.to(mc, 2, {alpha:0}));
		...
		public function quickGlow(...movieClips):void
		{
			...
			for (var i:int=0; i < movieClips.length; i++)
			{
				timeline.append(TweenLite.to(movieClips[i], 1, {glowFilter:{color:0xF4A223, alpha:1, blurX:8, blurY:8, strength:2, remove:true, delay:2}}));
			}
		}
